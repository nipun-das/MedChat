...
def getDescription(disease):
    dscp = pd.read_csv("symptom_Description.csv")
    r = dscp.loc[dscp['Disease'] == disease]
    return r


def getPrecautions(disease):
    dscp = pd.read_csv("symptom_precaution.csv")
    r = dscp.loc[dscp['Disease'] == disease]
    return r
...
if __name__ == "__main__":
    ...
    exit_list = ["Bye", "See you later", "Goodbye", "Nice chatting to you, bye", "Till next time", "Thanks",
                 "Thank you"]
